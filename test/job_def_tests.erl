...
job_def_test_() ->
    [job1_checks(), job_def_encode_decode(),job_def_new_default(),
     ...
     end_of_job_priority_checks(), invalid_priority_checks(), 
     radar_mode_decode_reserved_checks(), cross_range_std_dev_checks()].
...
sample_job_def_params() ->
    [{job_id, 100}, {sensor_id_type, rotary_wing_radar},
     ...
     {radar_mode, {monopulse_calibration, asars2a}}, {nom_rev_int, 65000},
...
radar_mode_table() ->
    [{0, {unspecified_mode, generic}},
     ...
     {31, {wide_area_mti, asars2a}},
     {32, {coarse_res_search, asars2a}},
     {33, {med_res_search, asars2a}},
     {34, {high_res_search, asars2a}},
     {35, {point_imaging, asars2a}},
     {36, {swath_mti, asars2a}},
     {37, {repetititve_point_imaging, asars2a}},
     {38, {monopulse_calibration, asars2a}},
     {51, {search, asars_2}},
     ...
     {94, {was_mti_exo, sentinel}},
     {95, {was_mti_endo_exo, sentinel}},
     {96, {ss_mti_exo, sentinel}},
     {97, {ss_mti_endo_exo, sentinel}},
     {98, {rwas_mti_endo_exo, sentinel}},
     ...
     {123, {hrr_gmti, vader}},
     {132, {spotlight_scan, i_master}},
     {133, {sector_scan, i_master}},
     {134, {ground_stabilised_sector_scan, i_master}},
     {135, {mti, osprey}},
     {136, {mti_ss, osprey}},
     {137, {e_mti, osprey}},
