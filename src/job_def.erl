...
decode_sensor_id_type(13) -> anzpy_2;
...
decode_radar_mode(94) -> {was_mti_exo, sentinel};
decode_radar_mode(95) -> {was_mti_endo_exo, sentinel};
decode_radar_mode(96) -> {ss_mti_exo, sentinel};
decode_radar_mode(97) -> {ss_mti_endo_exo, sentinel};
decode_radar_mode(98) -> {rwas_mti_endo_exo, sentinel};
...
decode_radar_mode(132) -> {spotlight_scan, i_master};
decode_radar_mode(133) -> {sector_scan, i_master};
decode_radar_mode(134) -> {ground_stabilised_sector_scan, i_master};
...
erm({was_mti_exo, sentinel}) -> 94;
erm({was_mti_endo_exo, sentinel}) -> 95;
erm({ss_mti_exo, sentinel}) -> 96;
erm({ss_mti_endo_exo, sentinel}) -> 97;
erm({rwas_mti_endo_exo, sentinel}) -> 98;
...
erm({spotlight_scan, i_master}) -> 132;
erm({sector_scan, i_master}) -> 133;
erm({ground_stabilised_sector_scan, i_master}) -> 134;
erm({mti, osprey}) -> 135;
